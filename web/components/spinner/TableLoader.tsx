    ...
    return (
        <div className='my-4'>
            {Array.from({ length: 4 }).map((_, index) => (
                <div key={index} className="min-w-[900px] w-full flex items-center justify-between gap-1 md:gap-3 text-center border-b border-opacity-20 border-gray-500 bg-gray-100 p-3">
                    {/* Remove Button */}
