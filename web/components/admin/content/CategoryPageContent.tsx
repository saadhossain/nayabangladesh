...
import { categoryTableColumn } from '../../tables/table-columns/categoryTableColumn';
...
const CategoryPageContent = () => {
    ...
    const [columns] = useState(() => [...categoryTableColumn])
        ...
        <div className='w-full'>
            ...
            </div>
            {
                isLoading ? <TableLoader /> : <div className='w-full'>
                    {
                        categories?.length <= 0 ? <NoNewsFound /> : (
